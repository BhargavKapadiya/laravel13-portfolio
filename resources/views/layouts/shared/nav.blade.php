        ...
        <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-4">
            ...
            <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link fw-medium" aria-current="page" href="{{ route('home') }}#landingHero">Home</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link fw-medium" href="{{ route('home') }}#landingContact">Contact us</a>
                    </li>
                </ul>
            </div>
            ...
            <ul class="navbar-nav flex-row align-items-center ms-auto">
                    ...
                    <li class="nav-item navbar-dropdown dropdown-user dropdown">
                        <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                            <div class="avatar avatar-online">
                                <img src="{{ Helper::assets('assets/img/avatars/1.png') }}" alt class="w-px-40 h-auto rounded-circle" />
                            </div>
                        </a>
                ...
                @guest
                    <a href="{{ route('login') }}" class="btn btn-primary"><span class="tf-icons bx bx-user me-md-1"></span><span class="d-none d-md-block">Login/Register</span></a>
                @endguest
                </li>
                <!-- navbar button: End -->
