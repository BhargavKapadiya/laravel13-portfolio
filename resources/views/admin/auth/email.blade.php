            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.password.email') }}" method="post" id="formAuthentication" class="mb-3 forgot-form-validate">
                            @csrf
                            <div class="mb-3">
                                <label for="email" class="form-label">Email</label>
                                <input type="email" name="email" value="{{ old('email') }}" class="form-control @if ($errors->has('email')) is-invalid @endif" id="email" placeholder="Enter your email" autofocus />
                                @if ($errors->has('email'))
