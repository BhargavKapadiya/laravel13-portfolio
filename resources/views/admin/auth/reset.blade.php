                        ...
                        <form action="{{ route('admin.password.update') }}" method="post" class="reset-form-validate authentication-form">
                            ...
                            <div class="mb-3 form-password-toggle">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" class="form-control @if ($errors->has('password')) is-invalid @endif" id="password" name="password" required="" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" data-error="password-error" aria-describedby="password" aria-required="true" aria-invalid="false" />
                            ...
                            <div class="mb-3 form-password-toggle">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" class="form-control @if ($errors->has('password_confirmation')) is-invalid @endif" id="password_confirmation" name="password_confirmation" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" data-error="password_confirmation-error" aria-required="true" aria-invalid="false" aria-describedby="password" />
                                    <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                                </div>
                                    ...
                                    <form action="{{ route('admin.password.update') }}" method="post" class="reset-form-validate authentication-form">
                                        ...
                                        <div class="form-group mt-4">
                                            ...
                                            <div class="input-group validation-valid-element">
                                                ...
                                                <div class="input-group-append">
                                                    <span class="input-group-text show-password" data-show-pass="password">
                                                        <i class="icon-eye" role="button"></i>
                                                    </span>
                                                </div>
                                            </div>
                                            <div class="password-error"></div>
                                        ...
                                        <div class="form-group mt-4">
                                            ...
                                            <div class="input-group validation-valid-element">
                                                ...
                                                <div class="input-group-append">
                                                    <span class="input-group-text show-password" data-show-pass="password_confirmation">
                                                        <i class="icon-eye" role="button"></i>
                                                    </span>
                                                </div>
                                            </div>
